<template>
  <div style="
    ...
    <div style="width: 400px; margin: 150px auto">
      <h1 style="text-align: center; color: limegreen">FindYourTeam</h1>
      <el-form ref="l_form" status-icon :model="l_form" :rules="rules" label-width="60px">
        <el-form-item style="text-align: center" prop="uid">
          <el-input prefix-icon="el-icon-user-solid" placeholder="学/工号" v-model="l_form.uid" clearable
            style="margin-top: 40px; margin-left: -60px"></el-input>
        </el-form-item>
        <el-form-item style="text-align: center" prop="password">
          <el-input prefix-icon="el-icon-lock" placeholder="密码" v-model="l_form.password" show-password
