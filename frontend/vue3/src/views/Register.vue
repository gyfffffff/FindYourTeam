    ...
    <div style="width: 400px; margin: 100px auto">
      ...
      <el-form ref="r_form" status-icon :model="r_form" :rules="rules" label-width="60px">
        <el-form-item style="text-align: center" prop="name">
          <el-input placeholder="姓名" v-model="r_form.name" clearable
            style="margin-top: 40px; margin-left: -60px"></el-input>
        </el-form-item>
        <el-form-item style="text-align: center" prop="uid">
          <el-input prefix-icon="el-icon-user-solid" placeholder="学/工号" v-model="r_form.uid" clearable
            style="margin-top: 5px; margin-left: -60px"></el-input>
        </el-form-item>
        <el-form-item style="text-align: center" prop="company">
          <el-input placeholder="所属学院" v-model="r_form.company" clearable
            style="margin-top: 5px; margin-left: -60px"></el-input>
        </el-form-item>
        <el-form-item style="text-align: center" prop="password">
          <el-input prefix-icon="el-icon-lock" placeholder="设置密码" v-model="r_form.password" show-password
            style="margin-top: 5px; margin-left: -60px"></el-input>
        </el-form-item>
        <el-form-item style="text-align: center" prop="verifyp">
          <el-input prefix-icon="el-icon-lock" placeholder="确认密码" v-model="r_form.verifyp" show-password
            style="margin-top: 5px; margin-left: -60px"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        name: [{ validator: validateLen, trigger: 'blur' }],
        uid: [{ validator: validateID, trigger: 'blur' }],
        company: [{ validator: validateLen, trigger: 'blur' }],
        password: [{ validator: validatePass, trigger: 'blur' }],
        verifyp: [{ validator: validatePass2, trigger: 'blur' }],
      },
    }
  },
  methods: {
