                ...
                <div class="left">
                    <div class="detailInfo">
                        <div class="info">
                            ...
                            ><span class="value">{{ projectData.intro }}</span>
                            <!-- <br /> -->
                            <br />
                            <br />
                            ...
                            ><span class="value">{{ projectData.ddl }}</span>
                            <!-- <br /> -->
                            <br />
                            <br />
                            <p class="infoItem">
                            ...
                            <br />
                            <br />
                            <span class="label">关联团队：</span
                            ><a class="link" @click="gotoGroup">{{
                                groupData.groupName
                            }}</a>
                            <!-- <br /> -->
                            <br />
                ...
                >
                    ...
                    <div style="padding: 20px">
                        ...
                        >
                            ...
                            <el-table-column prop="intro" label="任务详述">
                            </el-table-column>
                            <el-table-column
                                prop="xuehao"
                                label="对接人"
...
export default {
    ...
    methods: {
        ...
        getProj() {
            http.get("/project/byid", { params: { pid: this.projectId } }).then(
                (res) => {
                    ...
                    this.projectData.startdate = formatDate(
                        this.projectData.startdate
                    );
                    this.projectData.ddl = formatDate(this.projectData.ddl);
                }
            );
        },
        getGroup() {
            http.get("/group/bypid", {
                params: { pid: this.projectId, uid: this.uid },
            }).then((res) => {
        ...
        load() {
            http.get("/task/loadInProj", {
                ...
                this.tableData.filter((item) => {
                    ...
                    http.get("user/byid", { params: { uid: item.uid } }).then(
                        (res) => {
                            item.uid =
                                res.data.name + " (uid: " + item.uid + ")";
                        }
                    );
                });
                function formatDate(dateString) {
